...
//#endregion
//#region src/probe4.ts
var LANG = `root = Root("Tytuł", [sec], "podtytuł")
sec = Section("Sekcja", [tile])
tile = StatTile("Metryka", "42", "wskazówka")`;
var schema = library.toJSONSchema();
console.log("library.root =", JSON.stringify(library.root));
var a = createStreamingParser(schema, library.root).set(LANG);
console.log("A) z library.root:", JSON.stringify(a.root?.props ?? null).slice(0, 200));
var b = createStreamingParser(schema).set(LANG);
